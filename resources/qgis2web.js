...
map.getView().fit([-11288387.651084, -7489065.074011, -3258275.296102, -2396645.928457], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Construir 2034 - Plan de Obras 2024 - 2033</h2>';
        return titleElement;
    })(),
